    ...
    for (let ty = 0; ty < tall; ty++) {
      for (let tx = 0; tx < wide; tx++) {
        ...
        if (fourCC === DXT1) {
          ...
          // Colour first, alpha over it: the colour half writes an opaque
          // fourth channel of its own, and a BC2 tile's alpha is the eight
          // bytes in front of it rather than anything the colour says.
